...
public class ProgramSekolah extends JFrame {
    ...
    public ProgramSekolah() {
        setTitle("Program Sekolah SDIT AL FADL");
        ...
        URL imgURL = getClass().getResource("/pmb/program_sekolah.png");
        ...
        if (imgURL != null) {
            ...
            JOptionPane.showMessageDialog(this, 
                "File 'program_sekolah.png' tidak ditemukan di folder src/pmb/!", 
